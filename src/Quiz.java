...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        qno = new JLabel();
        qno.setBounds(80, 400, 30, 20);
        qno.setFont(new Font("Tahoma", Font.PLAIN, 24));
        add(qno);
        
        question = new JLabel();
        question.setBounds(110, 400, 800, 30);
        ...
        questions[1][1] = "James Gosling";
        questions[1][2] = "Guido van Rossum";
        ...
        questions[5][0] = " Which of these cannot be used for a variable name in Java?";
        questions[5][1] = "identifier & keyword";
        questions[5][2] = "keyword";
        questions[5][3] = "identifier";
        questions[5][4] = "none of the mentioned";
        ...
        lifeline.setBounds(900, 570, 200, 40);
        ...
        submit.setBounds(900, 640, 200, 40);
