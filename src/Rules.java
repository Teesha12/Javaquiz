    ...
    Rules(String name) {
        ...
        rules.setText(
            "<html>"+ 
                ...
                "2. you can also eliminate 2 options for any one question by using the 50-50 lifeline" + "<br><br>" +
                "3. select next after completing each question" + "<br><br>" +
                "4. select submit after completing the quiz." + "<br><br>" +
